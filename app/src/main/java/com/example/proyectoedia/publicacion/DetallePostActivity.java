...
public class DetallePostActivity extends AppCompatActivity {
    ...
    String  suUid, miUid, miNombre, miDp, postId,pLikes, suDp,suNombre, pImagen;
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if(id == 0){
                    ...
                    Intent intent = new Intent(DetallePostActivity.this,DetallePostActivity.class);
        ...
        imagenRef.delete()
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                Toast.makeText(DetallePostActivity.this, "Borrado correctamente", Toast.LENGTH_SHORT).show();
                                pd.dismiss();
                            }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        pd.dismiss();
                        Toast.makeText(DetallePostActivity.this, ""+ e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void comentarioPost() {
        ...
        hashMap.put("Comentarios",comentario);
        ...
        ref.child(fechayHora).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        //añadido
                        pd.dismiss();
                        Toast.makeText(DetallePostActivity.this, "Comentario añadido!", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        pd.dismiss();
                        Toast.makeText(DetallePostActivity.this, "Algo salió mal: "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
